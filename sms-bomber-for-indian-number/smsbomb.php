...
?>
    ...
    <body>
        ...
        <!-- <div class='footer'>
            <h2 style='color:lightblue'>Created by : <font color='white'>sanonymousNitin</h2>
        </div> -->
    </body>
</html>
<?php
...
?>
    ...
    <body>
        <center>
            <h1 style="color:red">SmS BomBer</h1><h2> <font color="orange">te</font><font color="white">rm</font><font color="green">ux</font></h2><hr><hr>
        ...
        <div class='footer'>
            <h2 style='color:lightblue'>Created by : <font color='white'>B╘▲«k░£▲G╘è</h2>
        </div>
    </body>
</html>
